  ...
  return (
    <aside className="w-64 bg-slate-900 flex flex-col h-screen sticky top-0 shrink-0">
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-slate-700">
        ...
        <div>
          <p className="text-white font-bold text-base leading-tight">AviMax</p>
          <p className="text-brand-400 text-xs font-medium">Central Admin</p>
        </div>
      </div>
      ...
      <div className="px-5 py-3 border-t border-slate-700">
        <p className="text-xs text-slate-500">v0.1.0 — Multi-House</p>
      </div>
    </aside>
  )
}
